...
For metagenome analysis, computational requirements were assessed on a machine with Intel Xeon Processor (2.6 GHz) virtualized to 98 cores (72 cores used) and 200 GB of main memory
...
To whom is interested the parameters of each tool that involved in metagenomic data analysis. More details can be found in /R/run_pngsanalysis.R 
