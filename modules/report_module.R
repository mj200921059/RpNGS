...
# ============================================
# Server Module: Test Report
# ============================================
#mod_report_server <- function(id,clininfo_file,pathogen_human,results_folders,seqinfo_file) {
mod_report_server <- function(id,report_data) {
